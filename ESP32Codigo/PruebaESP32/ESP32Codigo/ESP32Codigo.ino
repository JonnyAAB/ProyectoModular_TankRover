...
/*const int LPWM1 = 4;    //Cambiar el numero por el numero de pin del ESP32 para el 
const int RPWM1 = 16;    //Cambiar el numero por el numero de pin del ESP32
const int LPWM2 = 5;    //Cambiar el numero por el numero de pin del ESP32
const int RPWM2 = 17;    //Cambiar el numero por el numero de pin del ESP32
const int En = 2;*/
